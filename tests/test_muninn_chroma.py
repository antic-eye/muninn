...
class TestUpsertMemory:
    def test_upsert_stores_document(self, chroma_client):
        from muninn_mcp.chroma import upsert_memory, get_collection
...
class TestQueryMemory:
    def test_returns_top_k_results(self, chroma_client):
        from muninn_mcp.chroma import upsert_memory, query_memory, get_collection
    ...
    def test_empty_collection_returns_empty(self, chroma_client):
        from muninn_mcp.chroma import query_memory, get_collection
...
class TestDeleteMemory:
    def test_delete_removes_entry(self, chroma_client):
        from muninn_mcp.chroma import upsert_memory, delete_memory, get_collection
    ...
    def test_delete_nonexistent_raises(self, chroma_client):
        from muninn_mcp.chroma import delete_memory, get_collection, MemoryNotFoundError
...
class TestListMemories:
    def test_list_returns_all_entries(self, chroma_client):
        from muninn_mcp.chroma import upsert_memory, list_memories, get_collection
    ...
    def test_invalid_limit_raises_value_error(self, chroma_client):
        from muninn_mcp.chroma import list_memories, get_collection
...
class TestWipeCollection:
    def test_wipe_returns_count_and_empties_collection(self, chroma_client):
        from muninn_mcp.chroma import upsert_memory, wipe_collection, get_collection
