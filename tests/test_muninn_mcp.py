...
class TestToolHandlers:
    def test_handle_memory_write_returns_id(
        ...
        from muninn_mcp.server import handle_memory_write
    ...
    def test_handle_memory_search_returns_results(
        ...
        monkeypatch.setattr(mp, "detect_project_name", lambda: "test-project")
        from muninn_mcp.server import handle_memory_write, handle_memory_search
    ...
    def test_handle_memory_list_returns_list(
        ...
        monkeypatch.setattr(mp, "detect_project_name", lambda: "test-project")
        from muninn_mcp.server import handle_memory_write, handle_memory_list
    ...
    def test_handle_memory_delete(self, fake_client, fake_embedding, monkeypatch):
        ...
        monkeypatch.setattr(mp, "detect_project_name", lambda: "test-project")
        from muninn_mcp.server import handle_memory_write, handle_memory_delete
    ...
    def test_handle_memory_list_projects(
        ...
        from muninn_mcp.server import handle_memory_write, handle_memory_list_projects
    ...
    def test_handle_memory_wipe_project_requires_confirm(
        ...
        from muninn_mcp.server import handle_memory_wipe_project
    ...
    def test_handle_memory_wipe_project_with_confirm(
        ...
        monkeypatch.setattr(mp, "detect_project_name", lambda: "test-project")
        from muninn_mcp.server import handle_memory_write, handle_memory_wipe_project
    ...
    def test_handle_memory_delete_not_found(
        ...
        monkeypatch.setattr(mp, "detect_project_name", lambda: "test-project")
        from muninn_mcp.server import handle_memory_delete
